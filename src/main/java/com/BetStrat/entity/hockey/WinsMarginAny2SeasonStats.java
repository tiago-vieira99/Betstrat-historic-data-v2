...
@AllArgsConstructor
@Entity
@Table(name = "WinsMarginAny2SeasonStats",  uniqueConstraints = { @UniqueConstraint(name = "uniqueseasonandcompetitionforteamwmany2", columnNames = { "teamID", "season", "competition" }) })
