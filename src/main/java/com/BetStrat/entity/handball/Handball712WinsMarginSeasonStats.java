...
@AllArgsConstructor
@Entity
@Table(name = "Handball712WinsMarginSeasonStats",  uniqueConstraints = { @UniqueConstraint(name = "uniqueseasonandcompetitionforteamwmh712", columnNames = { "teamID", "season", "competition" }) })
